...
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 gr00t/experiment/launch_finetune.py \
  ...
  --dataset-path /localhome/local-vennw/code/orca-template1-dev/task7_20260122_trimmed_with_mask \
  --embodiment-tag NEW_EMBODIMENT \
  --num-gpus 1 \
  --output-dir /localhome/local-vennw/code/Isaac-GR00T/outputs/task7_20260122_trimmed_with_mask \
  --save-total-limit 5 \
  --save-steps 5000 \
  --max-steps 100000 \
  --tune-visual \
